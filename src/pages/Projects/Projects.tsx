            ...
            <div className='main-projects'>
                ...
                <div className="h-64 flex grid grid-cols-2">
                    ...
                    <div className="project-container flex-1 pr-10">
                        <div className='projects-title'><a href="https://janeyao.itch.io/honk-n-hurdle" rel="noreferrer">Honk n Hurdle</a></div>
                        <hr/>
                    ...
                    {/* Section 3 */}
                    <div className="project-container flex-1 pr-10">
                        <div className='projects-title'><a href="https://janeyao.itch.io/fishy-cat-v2" rel="noreferrer">Fishy Cat</a></div>
                        <hr/>
                        <div className='projects-description'>
